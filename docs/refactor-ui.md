...
| 2 | TerminalModal split (Pane/Tabs/Actions/Header) | +900/-900 | 独立可 | TODO |
| 3 | ContainersTab split (style + 内部 component) | +800/-800 | — | TODO |
| 4 | (optional) EditableSessionName 共通化 | +200/-300 | #2, #3 | TODO |
