...
const supportsConnectResetError =
...
test.skipIf(!supportsConnectResetError)(
  "local-proxy: established CONNECT teardown stays silent (requires Bun >= 1.4.0 reset-error semantics)",
  async () => {
